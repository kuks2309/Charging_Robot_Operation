...
class ModbusRobotInterface:
    ...
    address 351: (write 1: rilham get gun, write 2: rilham put, write 3: cat get gun(from car), write 4: car put (charging port)
    address 352: (write 1: pose_back, write 2: pose_main)    
    """
    
    REGISTER_CMD = 351 # task number
    REGISTER_RESP = 352 # pose completion number
    REGISTER_POSE_MAIN = 301  # 301~306 (pose main)
    REGISTER_POSE_BACK = 307  # 307~312 (pose back)
    REGISTER_BASE_CAM = 158   # 158~169 (camera pose from robot world coordinate)
